...
try
{
    ...
    if (isset($_GET["titre"]))
    {
        ...
        elseif($_GET["titre"] == $fetch['titre'])
        {
            ...
            $resultat_debut = $fetch['date_debut_affiche'];
            $resultat_fin = $fetch['date_fin_affiche'];
            $resultat_duree = $fetch['duree_min'];
            $resultat_prod = $fetch['annee_prod'];
            echo "<br><h1>" . "<br>" . $resultat_titre . "</h1><br>" . "<br>";
            echo "<p>" . $resultat_resum . "</p><br>" . "<br>";
            echo "<p>Ce film dure " .$resultat_duree . " minutes.</p><br>" . "<br>";
            echo "<p>En salle du " .$resultat_debut . " au ". $resultat_fin .".</p><br>" . "<br>";
            echo "<p>Ce film fut produit en " .$resultat_prod . " .</p><br>" . "<br>";
        }
        else
        {
            $name=$_GET['titre'];
    ...
    if(empty($_GET["prenom"]) && isset($_GET["nom"]))
    {
        ...
        foreach($pdo->query($nom_only) as $row)
        {
            ...
            echo "<h1>" . $row['prenom'] . "</h1> <h1>" .$row['nom']  . "</h1></a><br>";
            echo $row['email'] . "<br>";
        }
    }
    elseif(isset($_GET["prenom"]) && empty($_GET["nom"]))
    {
        ...
        foreach($pdo->query($prenom_only) as $row)
        {
            ...
            echo "<h1><p>" .$row['prenom'] . " " .$row['nom']  . "</h1></p></a><br>";
    ...
    elseif (isset($_GET["prenom"]) && isset($_GET["nom"]))
    {
        ...
        {
            echo "<p><a href='Index.php?personne=" . $row['id_perso'] . "'" . "</p><br>";
            echo "<h1>" .$row['prenom'] . " " . $row['nom']  ."</h1></a><br>";
            echo $row['email'] . "<br>";
        }
    }
